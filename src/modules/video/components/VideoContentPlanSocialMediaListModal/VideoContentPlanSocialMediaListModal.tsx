...
import styles from "./VideoContentPlanSocialMediaListModal.module.scss";
...
export const VideoContentPlanSocialMediaListModal = ({
  isModalOpen,
  setIsModalOpen,
  socialMediaList,
  handleSelectNewSocialMedias,
    ...
    <Modal
      ...
      footer={[
        <Button
          ...
          disabled={
            isVideoNow
              ? isVideoNowLoading || selectCurrentSocialMedias.length === 0
