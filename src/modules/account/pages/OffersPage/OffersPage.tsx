  ...
  return (
    <div className={styles.offerPage}>
      ...
      <div className={styles.accountInfo}>
        ...
        <Title level={5}>Покупка в 3 шага:</Title>
      ...
      <div className={styles.whatsappInfo}>
        <Title level={5}>WhatsApp номер: 8-776-13-77-999</Title>
        <Button type="primary" size="large" href="https://wa.me/77761377999" target="_blank" className={styles.whatsappButton}>
