          ...
          await new Promise<void>((resolve, reject) => {
            ...
            img.onerror = async (e) => {
              ...
              if (template?.backgroundImage) {
                ...
                const baseUrls = [
                  isProd ? 'http://34.135.112.39' : 'http://localhost:8000',
                  isProd ? 'http://34.135.112.39' : 'http://127.0.0.1:8000',
                  process.env.REACT_APP_API_URL || (isProd ? 'http://34.135.112.39' : 'http://localhost:8000')
                ];
