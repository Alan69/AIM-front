  ...
  return (
    <section className={styles.docsSection}>
      ...
      <div className={styles.docsSection__text}>
        Настоящие Условия использования (далее – Условия) и Политика
        конфиденциальности персональных данных (далее – Политика
        конфиденциальности) распространяются на всю информацию, которую ТОО
        «A-Gene» (далее – Компания) может получить о пользователях в процессе их
        взаимодействия с сайтом aimmagic или мобильным приложением, совокупно
        именуемыми «Платформа». Компания соблюдает все требования, связанные с
        обработкой данных, включая защиту персональной информации пользователей,
        и предоставляет прозрачное управление данными в соответствии с
